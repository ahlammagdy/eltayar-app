...
import 'package:eltayar/delivery_app/dev_controller.dart/dev_accepted_con.dart';
...
class DevOrderHome extends StatelessWidget {
  const DevOrderHome({super.key});

  @override
  Widget build(BuildContext context) {
    Get.put(DevAcceptedController());
    return Scaffold(
        appBar: AppBar(
        ...
        body: GetBuilder<DevAcceptedController>(
            builder: (controller) => HandlingDataView(
                statusRequest: controller.statusRequest,
                widget: ListView.builder(
                    itemCount: controller.devAcceptedDataList.length,
                    itemBuilder: (context, index) => WaitingItem(
                          waitingOrdersModel:
                              controller.devAcceptedDataList[index],
                        )))));
  }
}

class WaitingItem extends GetView<DevAcceptedController> {
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  if (waitingOrdersModel.orderStatus == "3")
                    SizedBox(
                      width: double.infinity,
                      child: ElevatedButton(
                          style: ButtonStyle(
